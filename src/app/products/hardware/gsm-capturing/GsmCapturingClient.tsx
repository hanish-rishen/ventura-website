...
export default function GSMCapturingClient({ pageData }: GSMCapturingProps) {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="relative mb-12 overflow-hidden">
          <ScrollAnimationWrapper>
            ...
            >
              {pageData?.title || 'GSM Capturing System'}
            </motion.h1>
          </ScrollAnimationWrapper>
          <motion.div
            ...
            <div className="h-96 relative">
              {pageData?.mainImageUrl ? (
                <Image
                  ...
                  alt={pageData.title || 'GSM Capturing System'}
                  layout="fill"
                  objectFit="cover"

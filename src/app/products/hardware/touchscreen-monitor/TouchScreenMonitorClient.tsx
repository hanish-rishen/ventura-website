...
interface TouchscreenMonitorProps {
  pageData: {
    title: string;
    description: string;
    mainImageUrl?: string;
...
export default function TouchscreenMonitorClient({ pageData }: TouchscreenMonitorProps) {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="relative mb-12 overflow-hidden">
          <ScrollAnimationWrapper>
            ...
            >
              {pageData?.title || 'Touchscreen Monitor'}
            </motion.h1>
          </ScrollAnimationWrapper>
          <motion.div
            ...
            <div className="h-96 relative">
              {pageData?.mainImageUrl ? (
                <Image
                  ...
                  alt={pageData.title || 'Touchscreen Monitor'}
                  layout="fill"
                  objectFit="cover"
